...
GameState::GameState(Board *board)
{
  ...
  this->winning_combos[1][0] = 1;
  this->winning_combos[1][1] = 4;
  this->winning_combos[1][2] = 7;

  this->winning_combos[2][0] = 2;
  this->winning_combos[2][1] = 5;
  this->winning_combos[2][2] = 8;

  this->winning_combos[3][0] = 3;
  this->winning_combos[3][1] = 6;
  this->winning_combos[3][2] = 9;

  this->winning_combos[0][0] = 1;
  this->winning_combos[0][1] = 5;
  this->winning_combos[0][2] = 9;

  this->winning_combos[1][0] = 3;
  this->winning_combos[1][1] = 5;
  this->winning_combos[1][2] = 7;
}
